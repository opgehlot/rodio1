    ...
    return (
      <div className="w-full min-h-[70vh] flex items-center justify-center bg-gray-50">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-gray-600 font-medium text-sm">Loading your referral dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Invite business partners, share your exclusive code, and earn rewards on every successful activation.
            </p>
          </div>

          {/* Quick Share Code Banner Box */}
          <div className="w-full md:w-auto bg-indigo-50/80 border border-indigo-100 rounded-xl p-4 flex items-center justify-between gap-4">
            <div>
              <span className="text-xs font-semibold uppercase tracking-wider text-indigo-600">Your Referral Code</span>
              <div className="text-lg font-bold text-indigo-900 tracking-wide mt-0.5">
                {stats?.referralCode || 'N/A'}
              </div>
            </div>
            <button
              onClick={() => copyToClipboard(stats?.referralCode)}
              className={`px-4 py-2.5 rounded-lg text-xs font-semibold shadow-sm transition-all duration-200 flex items-center gap-1.5 ${
                copied
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center gap-4 transition hover:shadow-md">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500">Active Referral Code</p>
              <h3 className="text-xl font-bold text-gray-900 mt-1">{stats?.referralCode || 'N/A'}</h3>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center gap-4 transition hover:shadow-md">
            ...
            <div>
              ...
              <h3 className="text-2xl font-extrabold text-gray-900 mt-1">{stats?.totalReferrals || 0}</h3>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 sm:p-8 border-b border-gray-100 flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Track every user who registered using your code</p>
            </div>
          </div>
          ...
          {stats?.history && stats.history.length > 0 ? (
            ...
            <div className="py-16 text-center">
              ...
              <p className="text-gray-800 font-semibold text-base">No referrals found yet</p>
              <p className="text-gray-400 text-sm mt-1 max-w-sm mx-auto">
                Share your referral code with other business owners to start growing your earnings today!
              </p>
            </div>
          )}
        </div>
