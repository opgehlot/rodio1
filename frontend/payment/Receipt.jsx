// src/pages/dashboard/Receipt.jsx (or your receipt path)
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 p-8 border-b">
            <div>
              ...
              <h2 className="font-bold text-lg mt-1">{receipt.receiptNumber}</h2>
            </div>
            <div>
          ...
          <div className="p-8 border-b">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="font-semibold">{receipt.customer.mobile}</p>
              </div>
              <div>
                <p className="text-gray-500 text-sm">User Role</p>
                <p className="font-semibold capitalize">{receipt.customer.role}</p>
              </div>
              <div>
                <p className="text-gray-500 text-sm">Customer ID</p>
                <p className="font-semibold break-all">{receipt.customer.id}</p>
              </div>
              <div>
                <p className="text-gray-500 text-sm">Referral Code</p>
                <p className="font-semibold">{receipt.referralCode || "N/A"}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 border-b">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="font-semibold break-all">{receipt.orderId}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Payment ID</p>
                <p className="font-semibold break-all">{receipt.paymentId}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-semibold">{receipt.currency}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Amount</p>
                <p className="font-bold text-green-600 text-xl">₹ {receipt.amount}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-semibold">
                  {receipt.subscriptionStart
                    ? new Date(receipt.subscriptionStart).toLocaleDateString()
                    : "N/A"}
                </p>
              </div>
              <div>
                ...
                <p className="font-semibold">
                  {receipt.subscriptionEnd
                    ? new Date(receipt.subscriptionEnd).toLocaleDateString()
                    : "N/A"}
                </p>
              </div>
            </div>
          ...
          <div className="bg-gray-50 p-8 text-center">
            ...
            <p className="text-gray-600 mt-3">
              Thank you for choosing <span className="font-bold">RODIO</span>.
            </p>
            ...
            <div className="mt-8 border-t pt-5">
              <p className="font-semibold">© {new Date().getFullYear()} RODIO</p>
              <p className="text-sm text-gray-500 mt-1">www.rodio.in</p>
              <p className="text-sm text-gray-500">support@rodio.in</p>
            </div>
          </div>
        </div>
