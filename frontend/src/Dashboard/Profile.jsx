...
// import { useEffect, useState, useRef } from "react";
// import { Crown, Loader2, Camera,X, } from "lucide-react";
// import toast from "react-hot-toast";
// import API from "../api/api";
// import OwnerDetails from "../pages/dashboardpage/Profiledas/OwnerDetails";
// import FirmDetails from "../pages/dashboardpage/Profiledas/FirmDetails";
...
//       toast.error("Image size must be less than 5MB", { id: "photo-size-error" });
//       return;
//     }
...
//       <div className=" bg-slate-100  p-6 sm:p-8 mb-6">
//         <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-6 text-center sm:text-left">
//           {/* Avatar with Camera Overlay */}
//            <div className="relative group shrink-0">
//     <div
//       onClick={() => setShowImagePreview(true)}
//       className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-slate-100 flex items-center justify-center overflow-hidden border-2 border-slate-200 shadow-inner cursor-pointer"
//     >
//       <img
//         src={profileImage}
//         alt="Profile"
...
//       disabled={uploadingPhoto}
//       onClick={() => fileInputRef.current?.click()}
//       className="absolute inset-0 bg-slate-950/60 rounded-full flex flex-col items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer duration-150"
...
//           disabled={uploadingPhoto}
//           onClick={() => fileInputRef.current?.click()}
//           className="w-full mt-4 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2"
//         >
//           {uploadingPhoto ? (
//             <>
...
//             <h2 className="text-xl sm:text-2xl font-black text-slate-900 uppercase tracking-tight truncate">
//               {profileData?.firmName || profileData?.name || "Business Profile"}
//             </h2>
//             <p className="text-xs sm:text-sm font-semibold text-slate-500 break-all">
...
//                 <Crown size={13} /> {profileData?.role || "Transporter"}
//               </span>
//             </div>
//           </div>
//         </div>
...
//       {/* Accordion Dropdown Modules */}
//       <OwnerDetails profileData={profileData} onUpdateSuccess={setProfileData} />
//       <FirmDetails profileData={profileData} onUpdateSuccess={setProfileData} />
//       <VehicleServices profileData={profileData} onUpdateSuccess={setProfileData} />
//       <MyDocumentss profileData={profileData} onUpdateSuccess={setProfileData} />
//     </div>
//   );
// }
  ...
  return (
    <div className="w-full sm:px-6 lg:px-8 py-4">
      ...
      <div className="bg-slate-100 p-6 sm:p-8 mb-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-6 text-center sm:text-left">
          ...
          <div className="relative shrink-0">
            ...
            <div
              onClick={() => setShowImagePreview(true)}
              className="w-34 h-34 sm:w-28 sm:h-28 rounded-full bg-slate-100 flex items-center justify-center overflow-hidden border-2 border-slate-200 shadow-inner cursor-pointer"
            >
              <img
                src={profileImage}
                alt="Profile"
          ...
          >
            ...
            <div className="bg-black p-4">
              ...
              <button
                ...
                disabled={uploadingPhoto}
                onClick={() => fileInputRef.current?.click()}
                className="w-full bg-white text-black py-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-slate-200 transition active:scale-[0.98]"
              >
      ...
      <OwnerDetails
        ...
        onUpdateSuccess={setProfileData}
      />
