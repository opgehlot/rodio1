...
//               <motion.div
//                 className="pointer-events-none absolute -inset-full top-0 z-20 block h-[200%] w-1/2 -skew-x-12 bg-gradient-to-r from-transparent via-white/25 to-transparent blur-[2px]"
//                 animate={{
//                   x: ["-100%", "350%"],
//                 }}
//                 transition={{
