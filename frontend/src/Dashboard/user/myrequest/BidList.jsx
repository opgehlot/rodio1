...
//             const transporterObj = bid.transporter || {};
//             const providerObj = bid.provider || {};

//             const transporterId =
//               providerObj._id || transporterObj._id || transporterObj.id;
//             const firmName = transporterObj.firmName || "Transport Firm";
//             const ownerName =
//               transporterObj.ownerName || transporterObj.name || "Owner";
//             const mobile =
//               transporterObj.phoneNumber || transporterObj.mobile || "N/A";
...
//                         <CheckCircle size={16} /> Transporter Selected
//                         Successfully
//                       </p>
//                     </div>
//                   )}
            ...
            return (
              ...
              >
                ...
                <div className="p-5 pt-0 space-y-3">
                  ...
                  {/* Bottom Action Grid: View Profile & Accept */}
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    {/* View Profile Button with Lock Guard */}
                    <button
                      onClick={() => {
                        if (!isLoggedIn) {
                          navigate("/login", { state: { from: location } });
                      ...
                      className={`py-2.5 px-4 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition shadow-lg active:scale-95 ${
                        isAccepted
                          ? "bg-blue-600 hover:bg-blue-700 text-white shadow-blue-600/20"
                          : "bg-slate-200 hover:bg-slate-300 text-slate-600 shadow-slate-200/20"
                      }`}
                    >
                      {isAccepted ? <Eye size={14} /> : <Lock size={14} />}
                      <span>View Profile</span>
                    </button>
