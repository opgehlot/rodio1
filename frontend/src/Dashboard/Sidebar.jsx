...
export default function Sidebar({ open, setOpen }) {
  ...
  return (
    <>
      ...
      >
        {/* Mobile Close Button */}
        <div id="sidebar-mobile-close" className="lg:hidden flex justify-end p-4 pb-0">
          <button
        ...
        {/* Logo / Header Brand */}
        <div id="sidebar-header" className="px-6 py-6 border-b border-slate-200 flex items-center gap-3">
          <div id="sidebar-brand-icon" className="w-11 h-11 rounded-2xl bg-blue-600 text-white flex items-center justify-center shadow-md shrink-0 font-black">
            <Truck size={24} />
          </div>
          <div id="sidebar-brand-info">
            <h2 id="sidebar-brand-title" className="text-xl font-black tracking-wide text-slate-900">
              Rodio Tradelink
            </h2>
            <p id="sidebar-brand-role" className="text-[11px] font-bold text-slate-500 capitalize tracking-wider">
              {role || "User"} Control Panel
            </p>
          </div>
        </div>
        ...
        {/* Menu Navigation */}
        <nav id="sidebar-nav" className="flex-1 overflow-y-auto p-4 space-y-1.5 scrollbar-thin scrollbar-thumb-slate-300">
          {/* Main Dashboard Link (Always Free/Unlocked) */}
          <NavLink
            id="nav-profile"
            end
        ...
        {/* Footer Actions (Password & Logout) */}
        <div id="sidebar-footer" className="border-t border-slate-200 p-4 space-y-2 bg-white">
          <NavLink
